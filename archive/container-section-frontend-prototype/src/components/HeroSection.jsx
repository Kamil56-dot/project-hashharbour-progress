      ...
      <div className="relative z-10 max-w-[1280px] w-full mx-auto px-6 md:px-12 flex-1 flex flex-col justify-center">
        ...
        <div className="max-w-[720px] pt-4">
          ...
          <motion.h1
            ...
            className="font-brand text-[54px] sm:text-[68px] md:text-[76px] text-white italic tracking-wider leading-[1.02] mb-3 drop-shadow-[0_4px_25px_rgba(0,0,0,0.8)] select-none"
          >
            #HASHHARBOUR
          </motion.h1>
          ...
          <motion.div
            ...
            className="text-[24px] sm:text-[28px] md:text-[32px] font-bold leading-tight tracking-tight mb-4"
          >
          ...
          <motion.p
            ...
            className="text-[14px] sm:text-[15px] font-normal text-white/65 leading-[1.7] max-w-[460px] mb-8"
          >
