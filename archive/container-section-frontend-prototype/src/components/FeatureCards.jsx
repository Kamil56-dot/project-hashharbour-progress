      ...
      {features.map((feature, idx) => {
        ...
        return (
          <motion.div
            ...
            className="glass-panel rounded-[14px] p-7 cursor-pointer transition-all duration-300 card-hover-glow hover:-translate-y-1 flex flex-col justify-between group"
          >
            <div>
              {/* Icon Container */}
